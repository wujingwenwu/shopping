  ...
  <div>
    ...
    <div v-else>
       ...
       <div class="d-f j-c-s-b m-t-30">
        ...
        <van-radio name="1" checked-color="#07c160" v-model="checkAll" @click="clickedAll">全选</van-radio>
        </div>
        <div  v-else-if="checkAll===true"> 
       
        <van-radio name="1" checked-color="#07c160" v-model="checkAll" @click="clickedAll">取消全选</van-radio>
         </div>
         </div>
         <div>
          <div>合计:￥</div>
        ...
        <div class="d-f m-t-10" v-for="(item,index) in shopList" :key="index">
         <van-radio name="1" checked-color="#07c160" @click="clickRadio"  v-model="item.check"></van-radio>
         ...
         <div>
          ...
          <div class="d-f m-t-30">
           ...
           <van-stepper v-model="value" theme="round" button-size="22" disable-input class="title2" min="1" max="10" @change="clickAdd(item)"/>
          </div>
         </div>
        </div>
        </div>
