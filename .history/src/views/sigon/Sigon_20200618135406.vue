  ...
  <div>
    <div class="sigon">
      ...
      <div class="sigon1">
        ...
        <van-form>
          <!-- 输入任意文本 -->
          <van-field v-model="username" placeholder="USERNAME" maxlength="6" :rules="[{ required: true, message: '请填写用户名',}]" />
          <!-- 输入手机号，调起手机号键盘 -->
          <van-field v-model="password"  placeholder="PASSWORD" maxlength="12"  :rules="[{ required: true, message: '请填写密码'}]" />
          <!-- 允许输入正整数，调起纯数字键盘 -->
