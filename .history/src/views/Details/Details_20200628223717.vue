  ...
  <div>
    ...
    <div>
      ...
      <div class="d-f j-c-s-a m-t-15">
        ...
        <div>
         <div v-if="flag===true" @click="collection" this.cancelCollection="0">
          {{value}}
          <span class="collection">
            <van-icon name="like-o" color="red"/>
          </span>
        </div>
        <div v-if="flag=== false" @click="collections" this.cancelCollection="1">
          {{value}}
          <span class="collection">
      ...
      if(this.nickname===null){
         this.$dialog
          ...
          this.$api.collections(this.obj).then(res=>{
             localStorage.setItem("obj", this.obj); 
            console.log(res);
          }).catch(err=>{
            console.log(err);
          })
