  ...
  <div>
    ...
    <div>
      ...
      <div class="d-f j-c-s-a m-t-15">
        ...
        <div>
         <div v-if="flag===1" @click="collection" this.cisCollection="1">
          {{value}}
          <span class="collection">
            <van-icon name="like-o" color="red"/>
          </span>
        </div>
        <div v-if="flag=== 0" @click="collections" this.cisCollection="0">
          {{value}}
          <span class="collection">
