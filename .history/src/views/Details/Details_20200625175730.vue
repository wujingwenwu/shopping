       ...
       <van-action-sheet title="加入购物车" v-model="shows">
          <div class="content">
            ...
            <div class="d-f m-t-10">
              ...
              <van-stepper v-model="value" theme="round" button-size="26" disable-input  min="1"  max="50" class="m-t-20 m-l-20"/>
            </div>
            <van-button type="primary" size="large" class="details4" color="orange" @click="clickItemq">加入购物车</van-button>
          </div>
        </van-action-sheet>
