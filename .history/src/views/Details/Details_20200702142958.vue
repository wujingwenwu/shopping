    ...
    <div>
      <van-tabs title-active-color="red" color="white">
        ...
        <van-tab title="商品评论">
          ...
          <div  class=" m-l-10 m-t-10" v-for="(item,index) in ass" :key="index">
          <div v-if="this.ass.anonymous===false">
          <div v-for="(item1,index1) in item.user" :key="index1"> 
           <div class="d-f m-l-10">
           <img :src="item1.avatar" alt="" class="titles">
           <div>
           <div class="d-f">
            <div class="m-l-10">{{item1.nickname}}:</div>
           ...
           <div class="d-f">
            ...
            void-color="#eee"
          />
          <div class="m-t-10 m-l-10">{{item.content}}</div>
          </div>
         </div>
           </div>
           <div class="m-t-10 m-l-10">评论了图片</div>
          <div class="titles3"></div>
         </div>
       </div>
       </div>
         ...
         <div class=" m-l-10 m-t-10" v-for="(item,index) in ass" :key="index" v-else> 
           <div class="d-f m-l-10">
           <img :src="item.comment_avatar" alt="" class="titles">
           <div>
           <div class="d-f">
            <div class="m-l-10">{{item.comment_nickname}}:</div>
            <div class="titles1">{{item.comment_time}}</div>
           </div>
           <div class="d-f">
            <van-rate
