        ...
        <van-action-sheet title="购买" v-model="show">
          <div class="content">
            ...
            <div class="d-f m-t-10">
              ...
              <van-stepper v-model="value" theme="round" button-size="26" disable-input  class="m-t-20 m-l-20"/>
            </div>
            <van-button type="primary" size="large" class="details4">立即购买</van-button>
          </div>
        </van-action-sheet>
      </van-goods-action>
