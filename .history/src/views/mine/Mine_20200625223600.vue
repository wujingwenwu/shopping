  ...
  <div>
    ...
    <div v-else>
      ...
      <div class="back d-f f-d-c j-c-c a-i-c">
        ...
        <div class="f-c-b f-s-18 m-t-20" @click="click" v-if="out">退出登录</div>
        <div class="f-c-b f-s-18 m-t-20" v-else-if="out==false" @click="clickq"></div>
      </div>
      <div class="d-f j-c-s-a m-t-20">
        <div>
          <van-icon name="pending-payment" badge="99+" size="30px" />
  ...
  methods: {
    ...
    click() {
      ...
      this.$dialog
        ...
        .then(res => {
          (this.out = false), (this.value = "登录/注册");
        })
