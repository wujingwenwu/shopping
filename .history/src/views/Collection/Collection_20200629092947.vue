  ...
  <div v-else>
    ...
    <div class="d-f m-t-20">
      <div class="collection m-l-20">
        <img :src="arr.image" alt width="80" />
      </div>
      <div>
        <div class="m-l-20">{{arr.name}}</div>
        <div class="d-f">
          <div class="f-c-ho m-l-20 m-t-20">￥{{arr.orl_price}}</div>
...
export default {
  ...
  methods: {
    ...
    closes(){
      this.$api.cancelCollection(this.obj).then(res=>{
