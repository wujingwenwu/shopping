    ...
    <div>
      <van-swipe :autoplay="3000">
        ...
        <div v-if="item.goodsName">
          <img v-lazy="item.image" width="100%" height="200px" @click="goDetail(item,index)"/>
           </div>
           <div v-else-if="item.name">
            <img v-lazy="item.image" width="100%" height="200px" @click="goDetail(item,index)"/>
           </div>
           <div v-else>  <img v-lazy="item.image" width="100%" height="200px" @click="goDetail(item,index)"/></div>
        </van-swipe-item>
